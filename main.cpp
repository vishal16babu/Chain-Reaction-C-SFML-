...
/*int main()
{
    ...
    FILE*fout;
    fptr=fopen("gamefiles/regedit","rb+");//opening file regedit in rb+ mode
    fout=fopen("gamefiles/regedit","rb+");
    if (fptr == NULL)
    {
    ...
    sf::Music music;
    if(!music.openFromFile("gamefiles/music.wav"))//declaring music objects.If the music files don't exist or cannot be loaded, return.
    {
    ...
    sf::Music button;
    if(!button.openFromFile("gamefiles/sound.wav"))//declaring music objects.If the music files don't exist or cannot be loaded, return
    {
        cout<<"unable to load file sound.wav"<<endl;
        return -1;
    }
    sf::Music gameover;
    if(!gameover.openFromFile("gamefiles/gameover.wav"))//declaring music objects.If the music files don't exist or cannot be loaded, return
    {
    ...
    sf::Music claps;
    if(!claps.openFromFile("gamefiles/claps.wav"))//declaring music objects.If the music files don't exist or cannot be loaded, return
    {
    ...
    while (window->isOpen())
    {
        ...
        {
            window->clear();
            if(!texture.loadFromFile("gamefiles/instructions2.png"))
            {
        ...
        {
            window->clear();
            if(!texture.loadFromFile("gamefiles/instructions1.png"))
            {
        ...
        {
            window->clear();
            if(!texture.loadFromFile("gamefiles/4.png"))
            {
...
//code for highlighting the option in the main menu when mouse moves over it
                if(x>510&&y>167&&x<640&&y<218)
                {
                    if(!texture.loadFromFile("gamefiles/4.1.png"))
                    {
                ...
                if(x>648&&y>167&&x<773&&y<218)
                {
                    if(!texture.loadFromFile("gamefiles/4.2.png"))
                    {
                ...
                if(x>648&&y>252&&x<773&&y<302)
                {
                    if(!texture.loadFromFile("gamefiles/4.4.png"))
                    {
                ...
                if(x>510&&y>252&&x<640&&y<302)
                {
                    if(!texture.loadFromFile("gamefiles/4.3.png"))
                    {
                ...
                if(x>540&&y>335&&x<750&&y<390)
                {
                    if(!texture.loadFromFile("gamefiles/4.5.png"))
                    {
                ...
                if(x>540&&y>433&&x<750&&y<479)
                {
                    if(!texture.loadFromFile("gamefiles/4.6.png"))
                    {
                ...
                if(x>540&&y>506&&x<750&&y<551)
                {
                    if(!texture.loadFromFile("gamefiles/4.7.png"))
                    {
        ...
        {
            window->clear();
            if(!texture.loadFromFile("gamefiles/credits.jpg"))
            {
        ...
        if(w==0)
        {
            ...
            window->clear();
            if(!texture.loadFromFile("gamefiles/3.jpg"))
            {
        ...
        {
            if(!texture.loadFromFile("gamefiles/p1grid.png"))
            {
        ...
        if(w==5)
        {
            if(!texture.loadFromFile("gamefiles/p2grid.png"))
            {
        ...
        if(w==6)
        {
            ...
            window->clear();
            if(!texture.loadFromFile("gamefiles/p1w.jpg"))
            {
...
//load image p2w as player2 wins
            if(!texture.loadFromFile("gamefiles/p2w.jpg"))
            {
...
//load the player's grid
            ...
            if(!texture.loadFromFile("gamefiles/pgrid.png"))
            {
...
//system's turn load image sgrid
            if(!texture.loadFromFile("gamefiles/sgrid.png"))
            {
...
// inside the main loop, between window->clear() and window->display()
        ...
        if(w==9)
        {
            ...
            if(!texture.loadFromFile("gamefiles/win.jpg"))
            {
        ...
        if(w==10)
        {
            ...
            if(!texture.loadFromFile("gamefiles/lost.jpg"))
            {
